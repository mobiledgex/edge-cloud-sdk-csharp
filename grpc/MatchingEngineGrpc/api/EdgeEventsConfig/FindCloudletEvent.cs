...
namespace DistributedMatchEngine
{
  ...
  // FIXME should not be here. This isn't Guava, but is called by internal handlers.
  public class FindCloudletEvent : EventArgs
  {
    public FindCloudletReply newCloudlet;
    public FindCloudletEventTrigger trigger;

    public FindCloudletEvent(FindCloudletReply newCloudlet, FindCloudletEventTrigger trigger)
    {
